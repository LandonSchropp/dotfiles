...
- Custom Git commands in `config/git/bin/` (base-branch, branches, checkout, default-branch, delete-branches, force-pull, force-push, local-repos, my-branches, page, review, what-did-i-do)
